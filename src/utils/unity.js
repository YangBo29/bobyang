...
const delete3Dhost = threeDJson => {
    ...
    //     }
    // } else {
    //     // copy3D.backgroundWebUrl = `https://raydata-1252768023.cos.ap-beijing.myqcloud.com${wurl('path', copy3D.backgroundWebUrl)}`;
    //     // copy3D.modelWebUrl = `https://raydata-1252768023.cos.ap-beijing.myqcloud.com${wurl('path', copy3D.modelWebUrl)}`;
    // }
